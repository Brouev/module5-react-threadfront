    ...
    async event => {
      ...
      try {
        ...
        if (response.ok) {
          ...
          alert(
            `Échec de la connexion : ${errorData.message || 'Vérifiez vos identifiants.'}`
          );
        }
      } catch (error) {
  ...
  return (
    ...
    (
      <div className="Connexion">
        ...
        <div className='ConnexionFormLogin'>

          <form className='connexionformlogin-form' onSubmit={handleSubmit}>
            ...
            <button type="submit" className="Se_connecter" disabled={loading}>
        ...
        <div className="creerCompte" onClick={handleRegisterClick}>
