        ...
        <div className="ProfileContainer">
            <div className="GroupeSquare">
                <div className='TitleSquare'>
                    <svg className="RectangleProfile" width="3" height="89" viewBox="0 0 3 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                    </svg>
                    <h2>Profile</h2>
                </div>
            ...
            <div className='addPostCommentProfile'>
                ...
                <button className='addComment' placeholder="Add Comment" onClick={() => navigate('/')}>
